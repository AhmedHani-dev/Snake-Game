...
public class Game extends JPanel implements Runnable, KeyListener {
	...
	public void init() {
		snake = new ArrayList<Snake>();// to create arraylist
	...
	public void eat() {
		...
		if (!apple.getState())// to put apple every time
			CreateApple();
	}
	...
	public void paint(Graphics g) {
		g.setColor(Color.WHITE);// draws score boarder with white color
		...
		// for(int i=0;i<width/10;i++)//for debugging
		...
		if(apple.getState())		//to draw apple
			apple.draw(g);
